...
/*48*/		"	w[k] = w[k] - hitlearn * dw[k] -  hitlearn * 2*w[k] * decaimentoDePeso ;\n"
...
/*111*/		"}\n"
/*112*/		"\n"
/*1*/		"kV convFSum(Vr W, Vr B, Vr A, Vw Z, Vw S, int px, int py, int sx, int sy, int atx, int aty, int fx, int fy, int fz, int fid, int k0) {\n"
/*2*/		"	int k = get_global_id(0) + k0;\n"
/*3*/		"	int x, y, w;\n"
/*4*/		"\n"
/*5*/		"	kRap(k, x, y, w, sx, sy)\n"
/*6*/		"	REAL sum, f, v;\n"
/*7*/		"	int lf, le;\n"
/*8*/		"	sum = B[w];\n"
/*9*/		"	for (int m = 0; m < fx; m++) {\n"
/*10*/		"		for (int n = 0; n < fy; n++) {\n"
/*11*/		"			for (int z = 0; z < fz; z++) {\n"
/*12*/		"				lf = kMap4D(m, n, z, w, fx, fy, fz);\n"
/*13*/		"				le = kMap(x * px + m, y * py + n, z, atx, aty);\n"
/*14*/		"				f = W[lf];\n"
/*15*/		"				v = A[le];\n"
/*16*/		"				sum += f * v;\n"
/*17*/		"			}\n"
...
/*22*/		"}\n"
/*23*/		"\n"
/*24*/		"kV convFCalcGradZ(Vr ds, Vr z, Vw dz, int fid, int k0) {\n"
/*25*/		"	int k = get_global_id(0) + k0;\n"
/*26*/		"	dz[k] = ds[k] * func(fid, z[k]);\n"
/*27*/		"}\n"
/*28*/		"\n"
/*29*/		"kV convFCalcGradBAndFix(Vrw B, Vrw dB, Vr dZ, int dzx, int dzy, REAL hitLearn, REAL momento, REAL weightDecay, int k0) {\n"
/*30*/		"	int w = get_global_id(0) + k0;\n"
/*31*/		"	REAL sum = 0;\n"
/*32*/		"	for (int x = 0; x < dzx; ++x) {\n"
/*33*/		"		for (int y = 0; y < dzy; ++y) {\n"
/*34*/		"			sum += dZ[kMap(x, y, w, dzx, dzy)];\n"
/*35*/		"		}\n"
/*36*/		"	}\n"
/*37*/		"	dB[w] = sum + dB[w] * momento;\n"
/*38*/		"	B[w] = B[w] - hitLearn * (dB[w] + B[w] * weightDecay);\n"
/*39*/		"}\n"
/*40*/		"\n"
/*41*/		"kV convFCalcGradBBatch(Vrw dB, Vr dZ, int dzx, int dzy, long batchSize, int k0) {\n"
/*42*/		"	int w = get_global_id(0) + k0;\n"
/*43*/		"	REAL sum = 0;\n"
/*44*/		"	for (int x = 0; x < dzx; ++x) {\n"
/*45*/		"		for (int y = 0; y < dzy; ++y) {\n"
/*46*/		"			sum += dZ[kMap(x, y, w, dzx, dzy)];\n"
/*47*/		"		}\n"
/*48*/		"	}\n"
/*49*/		"	sum = sum / batchSize + dB[w];\n"
/*50*/		"	dB[w] = sum;\n"
/*51*/		"\n"
/*52*/		"}\n"
/*53*/		"\n"
/*54*/		"\n"
/*55*/		"kV convFCalcGradIn(Vr W, Vw da, Vr dz, int fx, int fy, int fz, int px, int py, int atx, int aty, int sx, int sy, int sz, int k0) {\n"
/*56*/		"	int k = get_global_id(0) + k0;\n"
/*57*/		"	int x, y, z;\n"
/*58*/		"	kRap(k, x, y, z, atx, aty)\n"
/*59*/		"	Range range_W;\n"
/*60*/		"	range_W.min.x = 0;\n"
/*61*/		"	if (x + fx > atx) {\n"
/*62*/		"		range_W.min.x = x + fx - atx;\n"
/*63*/		"	}\n"
/*64*/		"	range_W.max.x = fx - 1;\n"
/*65*/		"	if (x - fx + 1 < 0) {\n"
/*66*/		"		range_W.max.x = x;\n"
/*67*/		"	}\n"
/*68*/		"	range_W.min.y = 0;\n"
/*69*/		"	if (y + fy > aty) {\n"
/*70*/		"		range_W.min.y = y + fy - aty;\n"
/*71*/		"	}\n"
/*72*/		"	range_W.max.y = fy - 1;\n"
/*73*/		"	if (y - fy + 1 < 0) {\n"
/*74*/		"		range_W.max.y = y;\n"
/*75*/		"	}\n"
/*76*/		"	REAL somaErro = 0, pesoAplicado = 0;\n"
/*77*/		"	int i, j;\n"
/*78*/		"	int lf, ls;\n"
/*79*/		"	for (int m = range_W.min.x; m <= range_W.max.x; m++) {\n"
/*80*/		"		i = (x - m) / px;\n"
/*81*/		"		if (i * px + m != x) {\n"
/*82*/		"			continue;\n"
/*83*/		"		}\n"
/*84*/		"		for (int n = range_W.min.y; n <= range_W.max.y; n++) {\n"
/*85*/		"			j = (y - n) / py;\n"
/*86*/		"			if (j * py + n != y) {\n"
/*87*/		"				continue;\n"
/*88*/		"			}\n"
/*89*/		"			for (int w = 0; w < sz; w++) {\n"
/*90*/		"				lf = kMap4D(m, n, z, w, fx, fy, fz);\n"
/*91*/		"				ls = kMap(i, j, w, sx, sy);\n"
/*92*/		"				pesoAplicado = W[lf];\n"
/*93*/		"				somaErro += pesoAplicado * dz[ls];\n"
/*94*/		"			}\n"
/*95*/		"		}\n"
/*96*/		"	}\n"
/*97*/		"	da[k] = somaErro;\n"
/*98*/		"}\n"
/*99*/		"\n"
/*100*/		"kV convFCalcGradAndFixWeight(Vr W, Vr dz, Vr a, Vr dW, int fx, int fy, int fz, int a_tx, int a_ty, int s_tx, int s_ty, int px, int py, REAL hitLearn, REAL momento, REAL weightDecay, int k0) {\n"
/*101*/		"	int k = get_global_id(0) + k0;\n"
/*102*/		"	int m, n, z, l;\n"
/*103*/		"	kRep4D(k, m, n, z, l, fx, fy, fz)\n"
/*104*/		"	REAL soma = 0;\n"
/*105*/		"	int le, ls;\n"
/*106*/		"	for (int i = 0; i < s_tx; ++i) {\n"
/*107*/		"		for (int j = 0; j < s_ty; ++j) {\n"
/*108*/		"			le = kMap(i * px + m, j * py + n, z, a_tx, a_ty);\n"
/*109*/		"			ls = kMap(i, j, l, s_tx, s_ty);\n"
/*110*/		"			soma += a[le] * dz[ls];\n"
/*111*/		"		}\n"
/*112*/		"	}\n"
/*113*/		"	REAL dw = soma + dW[k] * momento;\n"
/*114*/		"	REAL w = W[k];\n"
/*115*/		"	W[k] = w - hitLearn * (dw + w * weightDecay);\n"
/*116*/		"	dW[k] = dw;\n"
/*117*/		"}\n"
/*118*/		"\n"
/*119*/		"kV convFCalcGradBatch(Vr dz, Vr a, Vr dW, long batchSize, int fx, int fy, int fz, int a_tx, int a_ty, int s_tx, int s_ty, int px, int py, int k0) {\n"
/*120*/		"	int k = get_global_id(0) + k0;\n"
/*121*/		"	int m, n, z, l;\n"
/*122*/		"	kRep4D(k, m, n, z, l, fx, fy, fz)\n"
/*123*/		"	REAL soma = 0;\n"
/*124*/		"	int le, ls;\n"
/*125*/		"	for (int i = 0; i < s_tx; ++i) {\n"
/*126*/		"		for (int j = 0; j < s_ty; ++j) {\n"
/*127*/		"			le = kMap(i * px + m, j * py + n, z, a_tx, a_ty);\n"
/*128*/		"			ls = kMap(i, j, l, s_tx, s_ty);\n"
/*129*/		"			soma += a[le] * dz[ls];\n"
/*130*/		"		}\n"
/*131*/		"	}\n"
/*132*/		"	soma = soma / batchSize + dW[k];\n"
/*133*/		"	dW[k] = soma;\n"
/*134*/		"}\n"
/*135*/		"\n"
...
/*40*/		"	}\n"
/*41*/		"	int i, j;//saida\n"
/*42*/		"	dA[kMap(x, y, z, entradatx, entradaty)] = 0;\n"
...
/*51*/		"				continue;\n"
/*52*/		"			}\n"
/*53*/		"			if (A[k] == S[kMap(i, j, z, saidatx, saidaty)]) {\n"
/*54*/		"				dA[k] = dS[kMap(i, j, z, saidatx, saidaty)];\n"
/*55*/		"				return;\n"
/*56*/		"			}\n"
/*57*/		"		}\n"
/*58*/		"	}\n"
