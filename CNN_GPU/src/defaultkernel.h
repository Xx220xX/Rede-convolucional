...
/*526*/		"\n"
/*527*/		"//poolav.h\n"
/*528*/		"kV PoolAvativa(Vector entrada, Vector saida, int lenFilter,\n"
/*529*/		"               int passo, int saidatx, int saidaty, int entradatx, int entradaty, int k0) {\n"
/*530*/		"	int k = get_global_id(0) + k0;\n"
/*531*/		"	int x, y, z;\n"
/*532*/		"	TensorRemap(k, x, y, z, saidatx, saidaty)\n"
/*533*/		"\n"
/*534*/		"	Ponto3d mapeado = {x * passo, y * passo, 0};\n"
/*535*/		"	double soma = 0, v;\n"
/*536*/		"\n"
/*537*/		"	for (int i = 0; i < lenFilter; ++i) {\n"
/*538*/		"		for (int j = 0; j < lenFilter; ++j) {\n"
/*539*/		"			soma += entrada[TensorMap(mapeado.x + i, mapeado.y + j, z, entradatx, entradaty)];\n"
/*540*/		"\n"
/*541*/		"		}\n"
/*542*/		"	}\n"
/*543*/		"	saida[k] = soma / (lenFilter * lenFilter);\n"
/*544*/		"}\n"
/*545*/		"\n"
/*546*/		"\n"
/*547*/		"kV PoolAvCalcGrads(Vector entrada, Vector gradEntrada, Vector gradNext, Vector saida,\n"
/*548*/		"                   int lenFilter, int passo, int entradatx, int entradaty, int entradatz, int saidatx, int saidaty,\n"
/*549*/		"                   int k0) {\n"
/*550*/		"	int k = get_global_id(0) + k0;\n"
/*551*/		"	int x, y;\n"
/*552*/		"	TensorRemap2D(k, x, y, entradaty)\n"
/*553*/		"	double somaErro = 0;\n"
/*554*/		"	Range range;\n"
/*555*/		"	range = mapeia_entrada_saida(x, y, passo, lenFilter, saidatx, saidaty, 1);\n"
/*556*/		"	for (int z = 0; z < entradatz; ++z) {\n"
/*557*/		"		somaErro = 0;\n"
/*558*/		"		for (int i = range.min.x; i <= range.max.x; i++) {\n"
/*559*/		"			for (int j = range.min.y; j <= range.max.y; j++) {\n"
/*560*/		"				somaErro += gradNext[TensorMap(i, j, z, saidatx, saidaty)];\n"
/*561*/		"			}\n"
/*562*/		"		}\n"
/*563*/		"		gradEntrada[TensorMap(x, y, z, entradatx, entradaty)] = somaErro/ (lenFilter * lenFilter);\n"
/*564*/		"	}\n"
/*565*/		"}\n"
/*566*/		"\n"
/*567*/		"\n"
/*568*/		"//relu.h\n"
/*569*/		"kV reluativa(Vector entrada, Vector saida, int k0) {\n"
/*570*/		"	int k = get_global_id(0) + k0;\n"
/*571*/		"	double v = entrada[k];\n"
/*572*/		"	if (v < 0)\n"
/*573*/		"		v = 0;\n"
/*574*/		"	saida[k] = v;\n"
/*575*/		"}\n"
/*576*/		"\n"
/*577*/		"kV relucalcgrad(Vector gradentrada, Vector entrada, Vector gradnext, int k0) {\n"
/*578*/		"	int k = get_global_id(0) + k0;\n"
/*579*/		"	gradentrada[k] = entrada[k] <= 0.0 ? (0) : gradnext[k];\n"
/*580*/		"}\n"
/*581*/		"\n"
/*582*/		"//softmax.h\n"
/*583*/		"kV SoftMaxativa1(Vector entrada, Vector exponent, Vector soma, int entradatx,\n"
/*584*/		"                 int entradaty,\n"
/*585*/		"                 int k0) {\n"
/*586*/		"	int k = get_global_id(0) + k0;\n"
/*587*/		"	int x, y, z;\n"
/*588*/		"	TensorRemap(k, x, y, z, entradatx, entradaty)\n"
/*589*/		"	exponent[k] = exp(entrada[k]);\n"
/*590*/		"	soma[z] += exponent[k];\n"
/*591*/		"}\n"
/*592*/		"\n"
/*593*/		"kV SoftMaxativa2(Vector exponet, Vector soma, Vector saida,\n"
/*594*/		"                 int saidatx, int saidaty, int k0) {\n"
/*595*/		"	int k = get_global_id(0) + k0;\n"
/*596*/		"	int x, y, z;\n"
/*597*/		"	TensorRemap(k, x, y, z, saidatx, saidaty)\n"
/*598*/		"	saida[k] = exponet[TensorMap(x, y, z, saidatx, saidaty)] / soma[z];\n"
/*599*/		"}\n"
/*600*/		"\n"
/*601*/		"kV softMaxcalcgrad(Vector gradentrada, Vector entrada, Vector gradnext, int k0) {\n"
/*602*/		"	int k = get_global_id(0) + k0;\n"
/*603*/		"	double xi = entrada[k];\n"
/*604*/		"	gradentrada[k] = xi * (1.0 - xi) * gradnext[k];\n"
/*605*/		"}\n"
/*606*/		"\n"
/*607*/		"\n"
;
