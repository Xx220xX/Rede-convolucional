...
/*610*/		"\n"
/*611*/		"\n"
/*612*/		"kV poolCalcGrads(Vector entrada, Vector gradEntrada, Vector gradNext, Vector saida,\n"
/*613*/		"				 int fx, int fy, int px, int py,\n"
/*614*/		"				 int entradatx, int entradaty,int saidatx, int saidaty,\n"
/*615*/		"				 int k0) {\n"
/*616*/		"	int k = get_global_id(0) + k0;\n"
/*617*/		"	int x, y, z;\n"
/*618*/		"	TensorRemap(k, x, y, z, entradatx, entradaty)\n"
/*619*/		"	Range range_filtro;\n"
/*620*/		"	range_filtro.min.x = 0;\n"
/*621*/		"	if (x + fx <= entradatx) {\n"
/*622*/		"		range_filtro.min.x = x + fx - entradatx;\n"
/*623*/		"	}\n"
/*624*/		"	range_filtro.max.x = fx - 1;\n"
/*625*/		"	if (x - fx + 1 < 0) {\n"
/*626*/		"		range_filtro.max.x = x;\n"
/*627*/		"	}\n"
/*628*/		"	range_filtro.min.y = 0;\n"
/*629*/		"	if (y + fy <= entradaty) {\n"
/*630*/		"		range_filtro.min.y = y + fy - entradaty;\n"
/*631*/		"	}\n"
/*632*/		"	range_filtro.max.y = fy - 1;\n"
/*633*/		"	if (y - fy + 1 < 0) {\n"
/*634*/		"		range_filtro.max.y = y;\n"
/*635*/		"	}\n"
/*636*/		"	int i, j;//saida\n"
/*637*/		"	gradEntrada[TensorMap(x, y, z, entradatx, entradaty)] =0;\n"
/*638*/		"	for (int m = range_filtro.min.x; m <= range_filtro.max.x; m++) {\n"
/*639*/		"		i = (x - m) / px;\n"
/*640*/		"		if (i * px + m != x)continue;\n"
/*641*/		"		for (int n = range_filtro.min.y; n <= range_filtro.max.y; n++) {\n"
/*642*/		"			j = (y - n) / py;\n"
/*643*/		"			if (j * py + n != y)continue;\n"
/*644*/		"			if (entrada[TensorMap(x, y, z, entradatx, entradaty)] ==\n"
/*645*/		"				saida[TensorMap(i, j, z, saidatx, saidaty)]) {\n"
/*646*/		"				gradEntrada[TensorMap(x, y, z, entradatx, entradaty)] =\n"
/*647*/		"						gradNext[TensorMap(i, j, z, saidatx, saidaty)];\n"
/*648*/		"				return;\n"
/*649*/		"			}\n"
/*650*/		"		}\n"
/*651*/		"	}\n"
...
/*655*/		"\n"
/*656*/		"//poolav.h\n"
/*657*/		"kV PoolAvativa(Vector entrada, Vector saida, int lenFilter,\n"
/*658*/		"               int passo, int saidatx, int saidaty, int entradatx, int entradaty, int k0) {\n"
/*659*/		"	int k = get_global_id(0) + k0;\n"
/*660*/		"	int x, y, z;\n"
/*661*/		"	TensorRemap(k, x, y, z, saidatx, saidaty)\n"
/*662*/		"\n"
/*663*/		"	Ponto3d mapeado = {x * passo, y * passo, 0};\n"
/*664*/		"	double soma = 0, v;\n"
/*665*/		"\n"
/*666*/		"	for (int i = 0; i < lenFilter; ++i) {\n"
/*667*/		"		for (int j = 0; j < lenFilter; ++j) {\n"
/*668*/		"			soma += entrada[TensorMap(mapeado.x + i, mapeado.y + j, z, entradatx, entradaty)];\n"
/*669*/		"\n"
/*670*/		"		}\n"
/*671*/		"	}\n"
/*672*/		"	saida[k] = soma / (lenFilter * lenFilter);\n"
/*673*/		"}\n"
/*674*/		"\n"
/*675*/		"\n"
/*676*/		"kV PoolAvCalcGrads(Vector entrada, Vector gradEntrada, Vector gradNext, Vector saida,\n"
/*677*/		"                   int lenFilter, int passo, int entradatx, int entradaty, int entradatz, int saidatx, int saidaty,\n"
/*678*/		"                   int k0) {\n"
/*679*/		"	int k = get_global_id(0) + k0;\n"
/*680*/		"	int x, y;\n"
/*681*/		"	TensorRemap2D(k, x, y, entradaty)\n"
/*682*/		"	double somaErro = 0;\n"
/*683*/		"	Range range;\n"
/*684*/		"	range = mapeia_entrada_saida(x, y, passo, lenFilter, saidatx, saidaty, 1);\n"
/*685*/		"	for (int z = 0; z < entradatz; ++z) {\n"
/*686*/		"		somaErro = 0;\n"
/*687*/		"		for (int i = range.min.x; i <= range.max.x; i++) {\n"
/*688*/		"			for (int j = range.min.y; j <= range.max.y; j++) {\n"
/*689*/		"				somaErro += gradNext[TensorMap(i, j, z, saidatx, saidaty)];\n"
/*690*/		"			}\n"
/*691*/		"		}\n"
/*692*/		"		gradEntrada[TensorMap(x, y, z, entradatx, entradaty)] = somaErro/ (lenFilter * lenFilter);\n"
/*693*/		"	}\n"
/*694*/		"}\n"
/*695*/		"\n"
/*696*/		"\n"
/*697*/		"//relu.h\n"
/*698*/		"kV reluativa(Vector entrada, Vector saida, int k0) {\n"
/*699*/		"	int k = get_global_id(0) + k0;\n"
/*700*/		"	double v = entrada[k];\n"
/*701*/		"	if (v < 0)\n"
/*702*/		"		v = 0;\n"
/*703*/		"	saida[k] = v;\n"
/*704*/		"}\n"
/*705*/		"\n"
/*706*/		"kV relucalcgrad(Vector gradentrada, Vector entrada, Vector gradnext, int k0) {\n"
/*707*/		"	int k = get_global_id(0) + k0;\n"
/*708*/		"	gradentrada[k] = entrada[k] <= 0.0 ? (0) : gradnext[k];\n"
/*709*/		"}\n"
/*710*/		"\n"
/*711*/		"//softmax.h\n"
/*712*/		"kV SoftMaxativa1(Vector entrada, Vector exponent, Vector soma, int entradatx,\n"
/*713*/		"                 int entradaty,\n"
/*714*/		"                 int k0) {\n"
/*715*/		"	int k = get_global_id(0) + k0;\n"
/*716*/		"	int x, y, z;\n"
/*717*/		"	TensorRemap(k, x, y, z, entradatx, entradaty)\n"
/*718*/		"	exponent[k] = exp(entrada[k]);\n"
/*719*/		"	soma[z] += exponent[k];\n"
/*720*/		"}\n"
/*721*/		"\n"
/*722*/		"kV SoftMaxativa2(Vector exponet, Vector soma, Vector saida,\n"
/*723*/		"                 int saidatx, int saidaty, int k0) {\n"
/*724*/		"	int k = get_global_id(0) + k0;\n"
/*725*/		"	int x, y, z;\n"
/*726*/		"	TensorRemap(k, x, y, z, saidatx, saidaty)\n"
/*727*/		"	saida[k] = exponet[TensorMap(x, y, z, saidatx, saidaty)] / soma[z];\n"
/*728*/		"}\n"
/*729*/		"\n"
/*730*/		"kV softMaxcalcgrad(Vector gradentrada, Vector entrada, Vector gradnext, int k0) {\n"
/*731*/		"	int k = get_global_id(0) + k0;\n"
/*732*/		"	double xi = entrada[k];\n"
/*733*/		"	gradentrada[k] = xi * (1.0 - xi) * gradnext[k];\n"
/*734*/		"}\n"
/*735*/		"\n"
/*736*/		"\n"
;
