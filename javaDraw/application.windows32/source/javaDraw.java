...
public class javaDraw extends PApplet {
...
public void drawImagem(PGraphics img) {
  if (mousePressed) {
...
public void putAns() {
  ...
  public void settings() {  size(940, 540); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "javaDraw" };
    if (passedArgs != null) {
