...
clib.TensorCpy.argtypes = [c.c_void_p,c.c_void_p,c.c_void_p,c.c_uint64]
clib.TensorCpy.restype = c.c_int
clib.TensorRandomize.argtypes = [c.c_void_p,c.c_void_p,c.c_int,c.c_double,c.c_double]
clib.TensorRandomize.restype = c.c_int
...
clib.CnnCalculeError.argtypes = [c.c_void_p,c.c_void_p]
clib.CnnCalculeError.restype = c.c_int
clib.CnnCalculeErrorWithOutput.argtypes = [c.c_void_p,c.c_void_p,c.c_void_p]
clib.CnnCalculeErrorWithOutput.restype = c.c_int
clib.CnnCalculeErrorTWithOutput.argtypes = [c.c_void_p,c.c_void_p,c.c_void_p]
clib.CnnCalculeErrorTWithOutput.restype = c.c_int
clib.CnnGetIndexMax.argtypes = [c.c_void_p]
clib.CnnGetIndexMax.restype = c.c_int
clib.Convolucao.argtypes = [c.c_void_p,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32,RandomParam]
clib.Convolucao.restype = c.c_int
clib.ConvolucaoNcausal.argtypes = [c.c_void_p,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32,RandomParam]
clib.ConvolucaoNcausal.restype = c.c_int
clib.Pooling.argtypes = [c.c_void_p,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32]
clib.Pooling.restype = c.c_int
clib.PoolingAv.argtypes = [c.c_void_p,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32]
clib.PoolingAv.restype = c.c_int
clib.Relu.argtypes = [c.c_void_p]
clib.Relu.restype = c.c_int
clib.PRelu.argtypes = [c.c_void_p,RandomParam]
clib.PRelu.restype = c.c_int
clib.Padding.argtypes = [c.c_void_p,c.c_uint32,c.c_uint32,c.c_uint32,c.c_uint32]
clib.Padding.restype = c.c_int
clib.BatchNorm.argtypes = [c.c_void_p,c.c_double,RandomParam,RandomParam]
clib.BatchNorm.restype = c.c_int
clib.SoftMax.argtypes = [c.c_void_p]
clib.SoftMax.restype = c.c_int
clib.Dropout.argtypes = [c.c_void_p,c.c_double,c.c_int64]
clib.Dropout.restype = c.c_int
clib.FullConnect.argtypes = [c.c_void_p,c.c_uint32,c.c_int,RandomParam]
clib.FullConnect.restype = c.c_int
clib.CnnCall.argtypes = [c.c_void_p,c.c_void_p]
clib.CnnCall.restype = c.c_int
clib.CnnCallT.argtypes = [c.c_void_p,c.c_void_p]
clib.CnnCallT.restype = c.c_int
clib.CnnLearn.argtypes = [c.c_void_p,c.c_void_p]
clib.CnnLearn.restype = c.c_int
clib.CnnLearnT.argtypes = [c.c_void_p,c.c_void_p]
clib.CnnLearnT.restype = c.c_int
...
clib.CnnLuaLoadString.argtypes = [c.c_void_p,c.c_void_p]
clib.CnnLuaLoadString.restype = c.c_int
...
clib.showVersion.argtypes = []
clib.showVersion.restype = None
...
clib.createManageTrain.argtypes = [c.c_void_p,c.c_double,c.c_double,c.c_double,c.c_int]
clib.createManageTrain.restype = c.c_void_p
clib.ManageTrainloadImages.argtypes = [c.c_void_p,c.c_int]
clib.ManageTrainloadImages.restype = c.c_int
clib.ManageTraintrain.argtypes = [c.c_void_p,c.c_int]
clib.ManageTraintrain.restype = c.c_int
clib.ManageTrainfitnes.argtypes = [c.c_void_p,c.c_int]
...
clib.createManageTrainPyStr.argtypes = [c.c_void_p,c.c_void_p,c.c_double,c.c_double,c.c_double]
clib.createManageTrainPyStr.restype = None
clib.PY_createCnn.argtypes = [c.c_void_p,c.c_double,c.c_double,c.c_double,c.c_uint32,c.c_uint32,c.c_uint32]
clib.PY_createCnn.restype = None
clib.PY_releaseCnn.argtypes = [c.c_void_p]
clib.PY_releaseCnn.restype = None
...
clib.setDefaultManageThread.argtypes = []
clib.setDefaultManageThread.restype = None
clib.setManageThread.argtypes = [c.CFUNCTYPE(c.c_void_p,c.c_void_p,c.c_void_p),c.CFUNCTYPE(c.c_int,c.c_void_p,c.c_int),c.CFUNCTYPE(c.c_int,c.c_void_p)]
clib.setManageThread.restype = None
